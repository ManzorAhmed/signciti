...
class SectionController extends Controller
{
    ...
    public function sectionOne($id)
    {
        ...
        $data_file = public_path('data/about_us_columns.json');
    ...
    {
        $data_file = public_path('data/status_company_columns.json');
        $content = File::get($data_file);
        $columns = json_decode($content, TRUE);
        $section = Section::findOrFail($id);
        $storedColumns = json_decode($section->content, TRUE);
    ...
    public function sectionThree($id)
    {
        ...
        $data_file = public_path('data/video_section_columns.json');
        $content = File::get($data_file);
        $columns = json_decode($content, TRUE);
        $section = Section::findOrFail($id);
        $storedColumns = json_decode($section->content, TRUE);
    ...
    public function sectionFour($id)
    {
        ...
        $data_file = public_path('data/footer_columns.json');
        $content = File::get($data_file);
        $columns = json_decode($content, TRUE);
        $section = Section::findOrFail($id);
        $storedColumns = json_decode($section->content, TRUE);
    ...
    public function sectionFive($id)
    {
        ...
        $data_file = public_path('data/pricing_columns.json');
        $content = File::get($data_file);
        $columns = json_decode($content, TRUE);
        $section = Section::findOrFail($id);
        $storedColumns = json_decode($section->content, TRUE);
    ...
    public function sectionSeven($id)
    {
        ...
        $data_file = public_path('data/contact_us_columns.json');
        $content = File::get($data_file);
        $columns = json_decode($content, TRUE);
        $section = Section::findOrFail($id);
        $storedColumns = json_decode($section->content, TRUE);
