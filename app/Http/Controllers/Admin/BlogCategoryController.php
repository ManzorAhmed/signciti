...
class BlogCategoryController extends Controller
{
    ...
    {
        return view('admin.blog_categories.index', ['title' => 'Categories List']);
    }
    ...
    public function getBlogCategories(Request $request)
    {
        ...
        if (empty($request->input('search.value'))) {
            $categories = BlogCategory::offset($start)
                ...
                ->orderBy($order, $dir)
                ->get();
            $totalFiltered = BlogCategory::count();
        } else {
            $search = $request->input('search.value');
            $categories = BlogCategory::where('name', 'like', "%{$search}%")
        ...
        if ($categories) {
            foreach ($categories as $r) {
                $edit_url = route('blog-categories.edit', $r->id);
                $nestedData['id'] = '
                                <td>
                                <div class="checkbox checkbox-success m-0">
                                        <input id="checkbox_' . $r->id . '" type="checkbox" name="blog_categories_id[]" value="' . $r->id . '">
    ...
    {
        return view('admin.blog_categories.create', ['title' => 'Add Categories']);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.blog_categories.edit', ['title' => 'Update Category Details', 'categories' => $categories]);
    }
    ...
    public function deleteSelectedBlogCategories(Request $request)
    {
        $input = $request->all();
        $this->validate($request, [
    ...
    {
        $categories = BlogCategory::findOrFail($request->input('id'));
        return view('admin.blog_categories.single', ['title' => 'Categories Detail', 'categories' => $categories]);
    }
