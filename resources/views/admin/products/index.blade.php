            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="btn-group pull-right">
                        <a class="btn btn-danger pull-right" onclick="del_selected()" href="javascript:void(0)">
                    ...
                    <p class="text-muted m-b-30">Product List</p>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function del_selected() {
            swal({
                ...
                $("#uform").submit();
                setTimeout(function () {
                    swal("products deleted successfully. Thanks");
                }, 2000);
            });
        }
    </script>
    ...
    <script>
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getProduct') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
