    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{{ route('categories.index') }}">Manage Inner Sub Categories</a></li>
                    <li class="active">Add Inner Sub Categories</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    <h3 class="box-title m-b-0">Add Inner Sub Category</h3>
                    {{ Form::open([ 'route' => 'inner-sub-categories.store','class'=>'form-horizontal generalForm' , 'enctype'=>'multipart/form-data']) }}
