    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{{ route('blog-categories.index') }}">Dashboard</a></li>
            ...
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    <div class="btn-group pull-right" role="group">
                        ...
                        <a class="btn btn-success pull-right" href="{{route('blog-categories.create')}}">
                    ...
                    <div class="table-responsive">
                        <form action="{{url('admin/delete-selected-blog-categories')}}" method="post" id="uform">
...
@section('scripts')
            ...
            swal({
                ...
                function () {
                    var APP_URL = {!! json_encode(url('/')) !!}
                        ...
                        window.location.href = APP_URL + "/admin/blog-categories/delete/" + id;
                });
    ...
    <script>
        ...
        var users = $('#users').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": "{{ route('admin.getBlogCategories') }}",
                "dataType": "json",
                "type": "POST",
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getBlogCategory') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
