    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{{ route('blog-categories.index') }}">Manage Categories</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    ...
                    {{ Form::model($categories, ['method' => 'PATCH','route' => ['blog-categories.update', $categories->id],'class'=>'form-horizontal generalForm','enctype'=>'multipart/form-data']) }}
                    ...
                    <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}" id="district">
                        ...
                        <div class="col-sm-4">
                            ...
                            @if(File::exists('uploads/images/'.$categories->image))
                                <img src="{{asset('uploads/images/'.$categories->image)}}" width="100" />
                            @endif
                        </div>
                    </div>
                    <div class="form-group m-b-0">
                        <div class="col-sm-offset-3 col-sm-4 text-center">
                            <a href="{{ route('blog-categories.index') }}" class="btn btn-info waves-effect waves-light
