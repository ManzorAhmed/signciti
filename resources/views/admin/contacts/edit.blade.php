    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{{ route('contacts.index') }}">Manage Contacts</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    <h3 class="box-title m-b-0">Edit Contacts -> {{ $contact->name }}</h3>
                    {{ Form::model($contact, ['method' => 'PATCH','route' => ['contacts.update', $contact->id],'class'=>'form-horizontal generalForm','enctype'=>'multipart/form-data']) }}
