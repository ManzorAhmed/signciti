...
<!-- ============================================================== -->
    ...
    <div id="page-wrapper">
                        ...
                        <div class="row row-in">
                            <div class="col-lg-4 col-sm-12 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$total_categories}}</h3></li>
                                    <li class="col-middle">
                            ...
                            <div class="col-lg-4 col-sm-12 row-in-br  b-r-none">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$total_sub_categories}}</h3></li>
                                    <li class="col-middle">
                            ...
                            <div class="col-lg-4 col-sm-12  b-0">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$total_inner_sub_categories}}</h3></li>
                                    <li class="col-middle">
                                        <h4>Total Inner Sub Categories</h4>
                                        <div class="progress">
                        ...
                        <div class="row row-in">
                            <div class="col-lg-4 col-sm-12 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$total_questions}}</h3></li>
                                    <li class="col-middle">
                                        <h4>Total FAQs</h4>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4 col-sm-12 row-in-br">
                                <ul class="col-in">
                                    <li>
                                        <span class="circle circle-md bg-purple"><i class="ti-clipboard"></i></span>
                                    </li>
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$total_products}}</h3></li>
                                    <li class="col-middle">
        ...
        <footer class="footer text-center">
            {{ date('Y') }} &copy; @isset($setting['copy_right']){{ $setting['copy_right'] }}@endisset </footer>
    </div>
    <!-- ============================================================== -->
    <!-- End Page Content -->
    <!-- ============================================================== -->
