        ...
        <div class="top-left-part">
            ...
            <a class="logo" href="{{ route('admin.dashboard') }}">
                ...
                <b>
                    ...
                    <img src="@isset($setting['favicon']) {{ asset('uploads/'.$setting['favicon']) }}@endisset"
                ...
                <span class="hidden-xs">
                    ...
                    <img src="@isset($setting['admin_logo']) {{ asset('uploads/'.$setting['admin_logo']) }}@endisset"
                         alt="home" class="light-logo" height="45"/>
                     </span> </a>
        </div>
        <!-- /Logo -->
            ...
            <li class="dropdown">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#">
                    @if(isset($setting['favicon']))
                        <img src="{{ asset('uploads/'.$setting['favicon']) }}" alt="user-img" width="36"
                             class="img-circle">
                    @else
                    ...
                    <li>
                        <div class="dw-user-box">
                            ...
                            <div class="u-text">
                                ...
                                <a href="{{route('admin-profile')}}" class="btn btn-rounded btn-danger btn-sm">View
                                    Profile</a></div>
                        </div>
                    </li>
