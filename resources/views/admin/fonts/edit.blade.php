...
<div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{{ route('users.index') }}">Manage Fonts</a></li>
                    <li class="active">Edit Fonts</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title m-b-0">Edit Font -> {{ $font->name }}</h3>
                    {{ Form::model($font, ['method' => 'PATCH','route' => ['fonts.update', $font->id],'class'=>'form-horizontal'])}}
