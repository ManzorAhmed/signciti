							...
							<div class="section_1">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-8 align-self-center">
										...
										<select id="size1" class="form-control onchange_fun" name="size1">

											<option disabled selected>Choose Material...</option>

											<option value="3/16">3/16" Inside Diameter </option>

											<option value="1/4">1/4" Inside Diameter  </option>
								...
								<div class="price_section1">
									...
									<div class="d-lg-flex border-bottom border-top p-2">
										...
										<div class="col-lg-5 align-self-end">
											...
											<button type="button" class="btn font-weight-bold bg-danger border-danger btn-block  text-white">
                                                ADD TO CART
                                            </button>
