...
<div class="container mt-4">
                ...
                <div class="section_1">
                    ...
                    <div class="">
                        <div class="d-lg-flex border-bottom border-top p-2">
                            ...
                            <div class="col-lg-8 align-self-center p-2">
                                <select name="mounting_hardware1" class="form-control onchange_fun" id="mounting_hardware1">
					...
					<?php if($calculator_mode == 2 || $calculator_mode == 3){ ?>
						<div class="connection_type1">
							<div class="d-lg-flex border-bottom border-top p-2">
								...
								<div class="col-lg-8 align-self-center">
									 <a class="text-info" href="#" data-toggle="modal" data-target="#myModal"><span class="text-danger">* </span>View Connection Types</a>
								</div>
							</div>
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								<div class="modal-body p-0">
									<img class="rounded-top border-0" src="{{asset('front_end/images/connection-types.jpg')}}" style="max-width: -webkit-fill-available;"/>
								</div>
								<!-- Modal footer -->
								<div class="modal-footer d-block">
									<text class="d-inline-flex">Letter Connection Type</text>
									<div class="float-right">
										<a class="text-decoration-none p-1" style="font-size: 24px;" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fconnection-types.jpg" target="_blank" rel="noopener">
											<i class="fab fa-facebook-square"></i>
										</a>
										<a class="text-decoration-none p-1" style="font-size: 24px;" href="http://pinterest.com/pin/create/link/?url=u=http%3A%2F%2Fconnection-types.jpg" target="_blank" rel="noopener">
	...
	<section class="block block-bordered block-feature bg-gradient-gray-bl ">
		...
		<img class="lazyfade in" style="width: 100%" data-src="https://www.woodlandmanufacturing.com/skin/frontend/wmi/default/images/product_marketing/galvanized-steel-custom-photo.png" src="https://www.woodlandmanufacturing.com/skin/frontend/wmi/default/images/product_marketing/galvanized-steel-custom-photo.png">
		</div>
		</div>
		...
		<p>Each thin steel letter is custom cut per order. You choose the font. You choose the size. Then we cut it. Just for you.</p>
	...
	<div class="tab-acc-combo product-detail-tabs my-6">
		...
		<div class="nav nav-tabgroup justify-content-center" role="tablist"><a class="nav-link active" id="description-tab" data-toggle="tab" href="#description-tabcontent" role="tab" aria-controls="description-tabcontent" aria-selected="true">Description</a><a class="nav-link" id="sizing-tab" data-toggle="tab" href="#sizing-tabcontent" role="tab" aria-controls="sizing-tabcontent" aria-selected="false">Sizing</a><a class="nav-link" id="pricing-tab" data-toggle="tab" href="#pricing-tabcontent" role="tab" aria-controls="pricing-tabcontent" aria-selected="false">Pricing</a></div>
		<div class="tab-content card card-acc-combo"><a class="card-header btn-acc superactive" data-acctarget="#description-tab" href="#description-tabcontent">Description</a><div class="card-body tab-pane active show" id="description-tabcontent" role="tabpanel" aria-labelledby="description-tab">
		<div class="row">
		<div itemprop="description" class="col-sm-8 std long-description article-content article-grid" style="font-size: 1.1rem;">
		{!! $product->description !!}
        </div>
		...
		<li>Width is approximate and may be significantly different if letter connect option is selected</li>
		<li>Comment if an exact size is needed</li>
		<li>Approximate width above is for separate letters</li>
		<li>Words/Names with the Letter Connect option will be approximately 20% less wide</li>
		<li>Words/Names with Baseline Connect will be approximately the width advertised</li>
		...
		Width is approximate, and may be significantly different with certain fonts. Selecting Letter Connect for this product can greatly reduce the overall width from what is stated. Please use the comment box if an exact size is needed.
		</p> </ul></div>
		<div class="card-footer text-muted">
		<ul class="fa-ul">
		<li><span class="attribute-icons"><span class="fa-li"><svg class="svg-inline--fa fa-wmi-warr-10 fa-w-16" aria-hidden="true" data-prefix="fas" data-icon
a-w-16" aria-hidden="true" data-prefix="fas" data-icon="wmi-rain-cloud" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M488.321,230.5c0,43-42.22,80-92.883,80H132.833c-59.952,0-108.082-43-108.082-93c0-37,25.332-70,62.485-85 c-0.844-3-0.844-6-0.844-9c0-58,55.729-105,123.281-105c52.352,0,96.261,27,114.837,65c10.132-8,24.487-13,39.686-13 c34.62,0,61.641,24,61.641,53c0,10-3.377,20-9.288,28C457.079,160.5,488.321,192.5,488.321,230.5z M296.679,357.5l-133,133 c-2,2-4,3-7,3c-2,0-4-1-6-3l-14-14c-2-2-3-4-3-7c0-2,1-4,3-6l133-133c1-2,4-3,6-3c3,0,5,1,7,3l14,14c2,2,3,4,3,7 C299.679,353.5,298.679,355.5,296.679,357.5z M186.679,357.5l-46,46c-2,2-4,3-6,3c-3,0-5-1-7-3l-14-14c-2-2-3-4-3-6c0-3,1-5,3-7 l46-46c2-2,4-3,7-3c2,0,4,1,6,3l14,14c2,2,3,4,3,7C189.679,353.5,188.679,355.5,186.679,357.5z M100.679,444.5l-47,46c-1,2-4,3-6,3 c-3,0-5-1-7-3l-14-14c-2-2-3-4-3-7c0-2,1-4,3-6l46-46c2-2,4-3,7-3c2,0,5,1,6,3l15,14c1,2,2,4,2,6 C102.679,440.5,101.679,442.5,100.679,444.5z M406.679,357.5l-46,46c-2,2-5,3-7,3s-5-1-7-3l-14-14c-2-2-3-4-3-6c0-3,1-5,3-7l46-46 c2-2,5-3,7-3s5,1,7,3l14,14c2,2,3,4,3,7C409.679,353.5,408.679,355.5,406.679,357.5z M319.679,444.5l-46,46c-2,2-5,3-7,3s-5-1-6-3 l-15-14c-1-2-3-4-3-7c0-2,2-4,3-6l47-46c1-2,4-3,6-3s5,1,7,3l14,14c2,2,3,4,3,6C322.679,440.5,321.679,442.5,319.679,444.5z"></path></svg><!-- <i class="fas fa-wmi-rain-cloud "></i> --></span></span><span class="fontsm">Outdoor Rated</span></li> <li><span class="attribute-icons"><span class="fa-li"><svg class="svg-inline--fa fa-wmi-recycle-alt fa-w-18" aria-hidden="true" data-prefix="fas" data-icon="wmi-recycle-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M299.009,181l35.715-20.404l-42.858-73.469l-69.39,120.412l-102.045-59.189l55.104-93.887 C183.698,39.155,199.005,32,218.394,32h158.169c12.245,0,20.409,4.093,26.532,13.277l32.654,56.135l35.715-20.411L414.319,181 H299.009z M170.433,297.465l35.715,20.464L151.044,219H33.692l35.716,19.271l-27.552,47.902c-2.041,4.082-3.062,10.175-3.062,14.257 c0,5.103,1.021,10.189,3.062,14.271l80.615,137.753C132.676,469.803,145.941,480,164.31,480H273V368H128.927L170.433,297.465z  M536.772,276.931l-54.084-93.881L380.644,241.34L453.645,368H365v-33.27l-59.186,89.145L365,512v-32h62.585 c11.225,0,21.43-6.123,26.531-14.286l80.615-138.781C543.915,309.585,544.937,292.238,536.772,276.931z"></path></svg><!-- <i class="fas fa-wmi-recycle-alt "></i> --></span></span><span class="fontsm">100% Scrap is recycled</span></li> <li><span class="attribute-icons"><span class="fa-li"><svg class="svg-inline--fa fa-wmi-usa-flag fa-w-16" aria-hidden="true" data-prefix="fas" data-icon="wmi-usa-flag" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M480,300v8c0,8.837-7.163,16-16,16H112c-8.837,0-16-7.163-16-16v-8c0-8.837,7.163-16,16-16h352 C472.837,284,480,291.163,480,300z M464,348H112c-8.837,0-16,7.163-16,16v8c0,8.837,7.163,16,16,16h352c8.837,0,16-7.163,16-16v-8 C480,355.163,472.837,348,464,348z M28,80v384c0,8.837,7.163,16,16,16h8c8.837,0,16-7.163,16-16V80c0-8.837-7.163-16-16-16h-8 C35.163,64,28,71.163,28,80z M464,132c8.837,0,16-7.163,16-16v-8c0-8.837-7.163-16-16-16H112c-8.837,0-16,7.163-16,16v136 c0,8.837,7.163,16,16,16h352c8.837,0,16-7.163,16-16v-8c0-8.837-7.163-16-16-16H288v-24h176c8.837,0,16-7.163,16-16v-8 c0-8.837-7.163-16-16-16H288v-24H464z"></path></svg><!-- <i class="fas fa-wmi-usa-flag "></i> --></span></span><span class="fontsm">Made in the USA</span></li> </ul>
		</div>
		</div>
		</div>
		</div>
		</div><a class="card-header btn-acc" data-acctarget="#sizing-tab" href="#sizing-tabcontent">Sizing</a>
		<div class="card-body tab-pane " id="sizing-tabcontent" role="tabpanel" aria-labelledby="sizing-tab"><div class=" product-main-content w-75 m-auto">
		<p>
		The letter height you order is based on the uppercase letter "B" of the font you specify. Depending on the font, <strong>some uppercase/lowercase letters may be shorter or taller than the height you specify on the order form</strong> so they will look proportionate to each other. Therefore, you may receive some of your lettering in different dimensions than the letter height ordered. If all lettering is ordered in lower case, we still scale the lettering to an uppercase "B" which will make most of the letters smaller than what was ordered. Please <a href="/contactus.html" target="_blank">contact us</a> if you would like to size your lettering differently from our standards. Please see examples below.
		</p>
		<div class="align-center" style="text-align: center;">
		<img class="p lazyload" style="max-width: 100%; height: auto;" data-src="https://res.cloudinary.com/woodland/image/upload/c_limit,d_ni.png,f_auto,h_300,q_auto,w_700/v1/woodland_media/skin/frontend/wmi/default/images/sizing/Ashley-Example.png">
		</div>
		</div>
		</div>
		<a class="card-header btn-acc" data-acctarget="#pricing-tab" href="#pricing-tabcontent">Pricing</a><div class="card-body tab-pane " id="pricing-tabcontent" role="tabpanel" aria-labelledby="pricing-tab">
		<div>
		<div class="mb-6 product-main-content"><ul class="addOptions"><li><i class="icon-plus" title="Price Increase"></i> Hanging Strips &amp; Paper Template Mounting is 10% more</li><li><i class="icon-plus" title="Price Increase"></i> Mounting Holes, Nails, Spacers &amp; Paper Template Mounting is 10% more</li><li><i class="icon-plus" title="Price Increase"></i> Mounting Holes Mounting is 5% more</li><li><i class="icon-plus" title="Price Increase"></i> Paper Template is $1.00 more per letter</li></ul></div>
