					...
					<div class="row justify-content-around align-items-center">
						...
						<div class="col-12 col-sm-6 col-lg-5 text-center text-md-left section-intro">
							<div class="px-3">
								...
								<p class="lead">Our {{$product->name}} are custom made to your exact specifications.Your {{$product->name}} can be customized in a variety of sizes and fonts. We then cut, sand, and clear coat them exclusively for you.</p>
											...
											<div class="card-footer text-muted">
												...
												<ul class="fa-ul">
													...
													<li><span class="attribute-icons"><span class="fa-li"><svg
															...
															class="fontsm">60-80% Recycled {{$product->name}} (20-35% Post-Consumer, 40-45% Pre-Consumer)--100% Scrap is Recycled</span>
