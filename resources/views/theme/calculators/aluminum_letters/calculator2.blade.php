...
<!-- Example 3 -->
                ...
                <div class="section_1">
                    ...
                    <div class="m1_finish1">
                        ...
                        <div class="d-lg-flex border-bottom border-top p-2">
                            ...
                            <div class="col-lg-8 align-self-center">
                                ...
                                <select class="onchange_fun form-control" id="m1_finish1" name="m1_finish1">
                    ...
                    <div class="m2_color1">
                        ...
                        <div class="d-lg-flex border-bottom border-top p-2">
                            ...
                            <div class="col-lg-8 align-self-center">
                                ...
                                <input type="color" id="m2_color1" name="m2_color1" class="form-control onchange_fun"/>
                    ...
                    <div class="m2_color1">
                        ...
                        <div class="d-lg-flex border-bottom border-top p-2">
                            ...
                            <div class="col-lg-8 align-self-center">
                                ...
                                <select class="form-control onchange_fun" id="m2_color1" name="m2_color1">

                                    <option value="">Choose Color...</option>

                                    <option value="#FFD700" class="" style="color:#FFD700; font-size:19px;">&#9634;
                                        Golden Polished Anodized
                                    </option>

                                    <option value="#6C541E" class="" style="color:#6C541E; font-size:19px;">&#9634;
                                        Medium Bronze Anodized
                                    </option>

                                    <option value="#804a00" class="" style="color:#804a00; font-size:19px;">&#9634; Dark
                                        Bronze Anodized
                                    </option>

                                    <option value="black" class="" style="color:black; font-size:19px;">&#9634; Black
                                        Polished Anodized
                                    </option>

                                    <option value="#c9d6d0" class="" style="color:#c9d6d0; font-size:19px;">&#9634;
                                        Clear Polished Anodized
                                    </option>
                        ...
                        <div class="d-lg-flex border-bottom border-top p-2">
                            ...
                            <div class="col-lg-8 align-self-center">
                                ...
                                <select name="mounting_hardware1" class="form-control"
                                    ...
                                    <option value="1">Flush Stud Mount ($4.85 per letter)</option>

                                    <option value="2">Projected Spacer ($4.85 per letter)</option>

                                    <option value="3">Projected Jam Nut ($4.85 per letter)</option>

                                    <option value="4">Corrugated Stud Mount ($4.85 per letter)</option>

                                    <option value="5">Flat Metal Wall Stud Mount ($4.85 per letter)</option>
                    ...
                    <div class="paper_template1">
                        ...
                        <div class="d-lg-flex border-bottom border-top p-2 ">
                            ...
                            <div class="col-lg-8 align-self-center p-md-2">
                ...
                <div class="w_c_p_section1">
                    ...
                    <div class="textarea_section1">
                        ...
                        <div class="col-md-12 p-2">
									...
									<textarea type="text" class="form-control" rows="7" id="text_area1"
                                              name="text_area1"
            ...
            <div class="row justify-content-around align-items-center">
                ...
                <div class="col-12 col-sm-6 col-lg-5 text-center text-md-left section-intro">
                    <div class="px-3">
                        ...
                        <p class="lead">Our {{$product->name}} are custom made to your exact
                            specifications.Your {{$product->name}} can be customized in a variety of sizes and fonts. We
                            then cut, sand, and clear coat them exclusively for you.</p>
    ...
    <section
        class="block py-sm-0 block-bordered d-none block-feature bg-gradient-gray-bl full-width text-sm-white bg-xs-none block-img-bg lazyfadebg in"
        data-src="https://www.woodlandmanufacturing.com/skin/frontend/wmi/default/images/product_marketing/aluminum-pano.jpg"
        style="background-position: center center; background-size: cover; background-repeat: no-repeat; position: relative; overflow: hidden; background-image: url(&quot;https://www.woodlandmanufacturing.com/skin/frontend/wmi/default/images/product_marketing/aluminum-pano.jpg&quot;);">
        <div class="container-c">
            <div class="row justify-content-around align-items-stretch">
                <div class="d-sm-none col-12 col-sm-6 justify-content-end pb-5 pt-0">
                    <div class="" style="height: 0; padding-bottom: 87.5%">
                        <img class="lazyfade rounded" style="width: 100%"
                             data-src="https://www.woodlandmanufacturing.com/skin/frontend/wmi/default/images/product_marketing/aluminum-stand.jpg">
                    </div>
                </div>
                ...
                <div
                    class="col-12 col-sm-6 col-lg-5 d-flex justify-content-center text-center text-md-left section-intro flex-column">
                    <div class="px-3 py-0 py-sm-7">
                        <h3 class="mb-3 display-3 text-white" style="text-align: Collapse;white-space: pre;">WHY MADE OF
                            ALUMINUM?</h3>
                        <p class="lead text-white">The finished {{$product->name}} is attractive and blends with any
                            décor.You can sand it to a satin finish or paint it in a variety of colors.</p>
                        <p class=" text-white">{{$product->name}} looks great and is extremely durable. Its toughness
                            enables it to last a lifetime.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row justify-content-around align-items-center">
                        <div class="col-12 col-sm-11">
                            <div class="px-3 text-center">
                                ...
                                <p class="lead">Letter sizing is complicated. In most fonts, different letters have
                                    different heights, especially lowercase letters.</p>
                                <p class="lead">We size everything proportionally to an uppercase “B”. Because of this,
                                    some letters may be shorter or taller than the height you select.</p>
                                ...
                                <div class="card" style="border: 1px solid rgba(0,0,0,.125);">
                                    ...
                                    <div class="card-body" style="font-size: .9rem;">
                                        ...
                                        <ul>
                                            ...
                                            <li>Best selling {{$product->name}}</li>
    ...
    function onchange_fun_sec2(id) {
...

        {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                cout_val2 = ((cout_val2)*this.responseText);
        ...
        xhttp.open("GET", "ajax.php?height1="+height2+"$thickness1="+thickness2+"$product_id="+product_id, true);
    ...
    function gettext1(id) {
...

        {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                cout_val1 = ((cout_val1)*this.responseText);
        ...
        xhttp.open("GET", "ajax.php?height1="+height1+"$thickness1="+thickness1+"$product_id="+product_id, true);
    ...
    function gettext2(id) {
        ...
        if (check == 'thickness' + status_count) {
            ...
            if (height2 <= 17 && thickness2 == "1/8") {
                ...
                $(".m2_finish" + status_count).show();

                $('#m2_finish' + status_count + ' option:eq(0)').prop('selected', true);
