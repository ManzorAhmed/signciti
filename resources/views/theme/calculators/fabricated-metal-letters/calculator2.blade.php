					...
					<div class="border">
						...
						<div class="section_1">
							...
							<div class="d-lg-flex border-bottom border-top p-2">
								...
								<div class="col-lg-8 align-self-center">
									<select id="height1" class="form-control onchange_fun" name="height1" required>
										<option value="" disabled selected value="">Choose Height...</option>
							...
							<div class="thickness_section1">
								<div class="d-lg-flex border-bottom border-top p-2">
									<div class="col-lg-3 text-lg-right align-self-center p-md-2"> Depth </div>
									<div class="col-lg-8 align-self-center">
										<select class="onchange_fun form-control depth1" id="depth1" name="depth1" required>
							...
							<div class="">
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-8 align-self-center">
										<select name="lexanback" class="form-control" id="lexanback1">
											<option value="" id="none">- Select an Option -</option>
											<option value="1">Clear</option>
											<option value="2">Light Diffused</option>
										</select>
									</div>
								</div>
							</div>
							<div class="">
								<div class="d-lg-flex border-bottom border-top p-2 ">
									...
									<div class="col-lg-8 align-self-center p-md-2">
										...
										<select name="ilocation1" class="form-control" id="ilocation1">
											<option value="">- Select an Option -</option>
								...
								<div class="d-lg-flex border-bottom border-top p-2 ">
									...
									<div class="col-lg-8 align-self-center p-md-2">
										<select name="ilocation1" class="form-control" id="ilocation1">
											...
											<option value="2">Raceway Mount</option>
										</select>
									</div>
								</div>
							</div>
						...
						<div class="d-lg-flex border-bottom border-top p-3">
							<div class="col-md-12 text-center align-self-center">
								<b>Power Supply and UL Certification:</b> <span class="">Pkg: LEDs, wires/cables, 12VDC power supply, UL labels, drawings, instructions, certification</span>
							</div>
						</div>
						<div class="d-lg-flex border-bottom border-top p-3">
							<div class="col-md-12 text-center align-self-center">
						...
						<div class="w_c_p_section1">
							...
							<div class="count_section1">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-md-6 align-self-end d-none">
					...
					<div class="row justify-content-around align-items-center">
						...
						<div class="col-12 col-sm-6 col-lg-5 text-center text-md-left section-intro">
							<div class="px-3">
								...
								<p class="lead">Our {{$product->name}} are custom made to your exact specifications.Your aluminum letters can be customized in a variety of sizes and fonts. We then cut, sand, and clear coat them exclusively for you.</p>
		...
		<script>
			...
			// {
				...
				// if (paint2 == 'automotive grade paint' || paint2 == 'craft paint') {
				...
				// if (paint2 == 'automotive grade paint') {
