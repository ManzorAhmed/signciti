					...
					<div class="border">
						...
						<div class="section_1">
							...
							<div class="d-lg-flex border-bottom border-top p-2">
								...
								<div class="col-lg-3 p-md-2 text-lg-right align-self-center">
							...
							<div class="">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-8 align-self-center">
										...
										<select class="form-control onchange_fun" id="finish" name="finish">
							...
							<div class="mounting_section1">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-3 p-md-2 text-lg-right align-self-center p-md-2">
						...
						<div class="w_c_p_section1">
							...
							<div class="price_section1">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-3 p-md-2 align-self-center d-flex p-md-2 p-lg-0">
									...
									<div class="col-lg-5 align-self-end">
										...
										<button type="button" class="btn font-weight-bold bg-danger border-danger btn-block  text-white">Add to
