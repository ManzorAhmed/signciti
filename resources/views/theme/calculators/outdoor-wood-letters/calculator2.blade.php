						...
						<div class="section_1">
							...
							<div class="">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-8 align-self-center p-2">
										...
										<select class="form-control onchange_fun" id="material1" name="material1">

											<option value="">Choose Material...</option>

											<option value="cedarunpainted">Cedar - Unpainted</option>

											<option value="mdounpainted">MDO - Unpainted</option>

											<option value="mdopainted">MDO - Painted (Automotive Grade)</option>
							...
							<div class="finish1">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-3 text-lg-right align-self-center "> Finish </div>

									<div class="col-lg-8 align-self-center p-2">

										<select class="onchange_fun form-control" id="finish1" name="finish1">

												<option disabled selected>Choose an Option...</option>

												<option value="Satin" class="80">Satin</option>

												<option value="10" class="80">High Gloss (+10%)</option>

												<option value="10" class="80">Matte (+10%)</option>
								...
								<div>
									...
									<div class="mb-6 product-main-content">
										...
										<ul class="addOptions">
											...
											<li><i class="icon-plus" title="Price Increase"></i> Polished material is 50% more
											...
											<li><i class="icon-plus" title="Price Increase"></i>
												...
												High Gloss material is 10% more
											...
											<li><i class="icon-plus" title="Price Increase"></i> Matte material is 10% more</li>
		...
		<script>
...

			{
				...
				if (height1 != '' && thickness1 != '') {
					...
					$.ajax({
						...
						data: {'height': height1, 'thickness': thickness1, 'material1': material1, 'product_id': product_id},
						...
						success: function (price) {
...

							{
								...
								cout_val1 = (+(cout_val1*finish1/100));
			...
			function add_mounting_hardware1() {
				...
				var projected_section1 = $("#projected_section1").val();
...

				{
					...
					$('#projected_spacer_length option:eq(0)').prop('selected', true);
...

			{
				...
				var material2 = $("#material"+status_count).val();
					...
					$.ajax({
						...
						success: function (price) {
...

							{
								...
								cout_val1 = (+(cout_val1*finish2/100));
			...
			function add_mounting_hardware2() {
				...
				var projected_spacer_length2 = $("#projected_spacer_length" + status_count).val();
...

				{
					...
					$('#projected_spacer_length'+status_count+' option:eq(0)').prop('selected', true);
