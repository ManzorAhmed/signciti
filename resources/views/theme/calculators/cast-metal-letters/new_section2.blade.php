    ...
    <div>
        ...
        <div class="thickness_section<?php echo $status_count; ?>">
            <div class="d-lg-flex border-bottom border-top p-2">
                ...
                <div class="col-lg-8 align-self-center">
                    <select class=" form-control" onchange="onchange_fun_sec2(this.id)" id="thickness<?php echo $status_count; ?>" name="thickness<?php echo $status_count; ?>" required >
			...
			<div class="m1_2_finish<?php echo $status_count; ?>">
				<div class="d-lg-flex border-bottom border-top p-2">
					<div class="col-lg-3 text-lg-right align-self-center p-md-2">
						Finish
					</div>
					<div class="col-lg-8 align-self-center">
						 <select class="form-control" id="m1_2_finish<?php echo $status_count; ?>" name="m1_2_finish<?php echo $status_count; ?>">
			...
			<?php } else if($calculator_mode == 2){?>
				<div class="m2_2_color<?php echo $status_count; ?>">
					<div class="d-lg-flex border-bottom border-top p-2">
						<div class="col-lg-3 text-lg-right align-self-center p-md-2">
							Color
						</div>
						<div class="col-lg-8 align-self-center">
							<input type="color" id="m2_2_color<?php echo $status_count; ?>" name="m2_2_color<?php echo $status_count; ?>" onchange="onchange_fun_sec2(this.id)" class="form-control" />
						</div>
					</div>
				</div>
			<?php } else if($calculator_mode == 1){?>
				<div class="m2_2_color<?php echo $status_count; ?>">
					<div class="d-lg-flex border-bottom border-top p-2">
						...
						<div class="col-lg-8 align-self-center">
							 <select class="form-control" id="m2_2_color<?php echo $status_count; ?>"  onchange="onchange_fun_sec2(this.id)" name="m2_2_color<?php echo $status_count; ?>">
								<option value="">Choose Color...</option>
									<option value="#FFD700" class="" style="color:#FFD700; font-size:19px;">&#9634; Golden Polished Anodized</option>
									<option value="#6C541E" class="" style="color:#6C541E; font-size:19px;">&#9634; Medium Bronze Anodized</option>
									<option value="#804a00" class="" style="color:#804a00; font-size:19px;">&#9634; Dark Bronze Anodized</option>
									<option value="black" class="" style="color:black; font-size:19px;">&#9634; Black Polished Anodized</option>
									<option value="#c9d6d0" class="" style="color:#c9d6d0; font-size:19px;">&#9634; Clear Polished Anodized</option>
							</select>
						</div>
					</div>
				</div>
