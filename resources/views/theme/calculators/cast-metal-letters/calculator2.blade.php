							...
							<?php if($calculator_mode == 2){ ?>
								<div class="thickness_section1">
									<div class="d-lg-flex border-bottom border-top p-2">
										...
										<div class="col-lg-8 align-self-center">
											<select class="onchange_fun form-control thickness1" id="thickness1" name="thickness1" required >
							...
							<div class="price_section1">
								...
								<div class="d-lg-flex border-bottom border-top p-2">
									...
									<div class="col-lg-5 align-self-end">
								    	<button type="submit" class="btn font-weight-bold bg-danger border-danger btn-block  text-white" >ADD TO CART</button>
									</div>
					...
					<div class="row justify-content-around align-items-center">
						...
						<div class="col-12 col-sm-6 col-lg-5 text-center text-md-left section-intro">
							<div class="px-3">
								...
								<p class="lead">Our {{$product->id}} are custom made to your exact specifications.Your {{$product->id}} can be customized in a variety of sizes and fonts. We then cut, sand, and clear coat them exclusively for you.</p>
										...
										<div class="card" style="border: 1px solid rgba(0,0,0,.125);">
											...
											<div class="card-body" style="font-size: .9rem;">
												...
												<ul>
													...
													<li>Best selling {{$product->id}} Letters</li>
											...
											<div class="card-footer text-muted">
												...
												<ul class="fa-ul">
													...
													<li><span class="attribute-icons"><span class="fa-li"><svg
															...
															class="fontsm">60-80% Recycled {{$product->id}} (20-35% Post-Consumer, 40-45% Pre-Consumer)--100% Scrap is Recycled</span>
			...
			function onchange_fun_sec2(id) {
				...
				if (height2 >= 18) {
					...
					if (height2 >= 18 && thickness2 == "1/8") {
						...
						$(".price" + status_count).text("2.00");

						$(".price" + status_count).val(2.00);
