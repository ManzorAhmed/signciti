                    ...
                    <div class="row align-items-center justify-content-center mb-5 mt-md-5">
                        ...
                        <div class="col-sm-4">
                            <ul class="checkout-types top list-unstyled">
                                <li>
                                    <a style="text-decoration: none;" href="{{route('product.check_out')}}" title="Proceed to Checkout"
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-12 col-sm-auto">
                                                                {{--   <a href="{{route()}}" rel="nofollow" title="Edit item parameters"
                                                                      class="text-warning">Edit</a> | --}}<a
                                                                    href="{{route('product.remove_cart',$product->id)}}"
                                                                    title="Remove Item"
                                                            ...
                                                            <tr class="collapse" id="collapse-{{$product_id}}">
                                                                <td colspan="3">
                                                                    <dl class="item-options">
                                                                        ...
                                                                        <dd>
                                                                            <div class="vtImage">
                                                                                --}}{{-- <div class="vtLine"><img
                                                                                         src="https://sx9kah-rk5vu5tke0is.cloudmaestro.com/hN-j71tya/viewerTool/includes/tmp_images/68xNa019c86aa8a762d4a431bca5edca86264.gif.pagespeed.ic.Yf9NN9bWPk.webp"
                                                                                         width="67.5" class="img1"></div>--}}{{--
                                                                                <div>
                                            ...
                                            <table id="shopping-cart-totals-table" class="table">
                                                ...
                                                <tr class="grand-total item-totals-row">
                                                    ...
                                                    <td style="" id="checkout_grand_total_parent" class="a-right value">
                                                        @if(session('grand_total')!=null)
                                                            <span class="price">${{session('grand_total')}}</span></td>
                                                    @else
