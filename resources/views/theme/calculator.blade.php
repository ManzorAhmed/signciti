...
<form method="post" action="{{route('product.add_cart')}}">
    ...
    <div class="container mt-4">
                            ...
                            <div class="d-lg-flex border-bottom border-top p-2">
                                ...
                                <div class="col-md-6 align-self-end">
                                    <div class="btn btn-light btn-block bg-light border-light add_new_section"
                                         id="add_new_section" onclick="add_new_section()"><i class="fas fa-plus"></i> Add New Line
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-around align-items-center">
                    ...
                    <div class="col-12 col-sm-6 col-lg-5 text-center text-md-left section-intro">
                        <div class="px-3">
                            ...
                            <p>All {{$product->name}} are cut custom per order. Choose from a variety of fonts and sizes to
                                design your {{$product->name}}. Then, we cut, sand, and clear coat them. Just for you.</p>
        ...
        <section class="block py-sm-0 block-bordered d-none block-feature bg-gradient-gray-bl full-width text-sm-white bg-xs-none block-img-bg lazyfadebg in"
            ...
            <div class="container-c">
                <div class="row justify-content-around align-items-stretch">
                    ...
                    <div
                        class="col-12 col-sm-6 col-lg-5 d-lg-flex justify-content-center text-center text-md-left section-intro flex-column">
                        <div class="px-3 py-0 py-sm-7">
                            <h3 class="mb-3 display-3 text-white">Why Aluminum?</h3>
                            <p class="lead text-white">Finished Aluminum is beautiful and fits in with any style. It can
                                be sanded for a shine, or painted a wide variety of colors.</p>
                            <p class=" text-white">Aluminum is a lightweight metal with crisp cut edges. It is extremely
                                durable with great longevity.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row justify-content-around align-items-center">
                            <div class="col-12 col-sm-11">
                                <div class="px-3 text-center">
                                    ...
                                    <p class="lead">We size everything proportionally to an uppercase “B”. Because of
                                        this, some letters may be shorter or taller than the height you select.</p>
    ...
    function add_new_section() {
        if (btn_count <= 2) {
            ...
            $.ajax({
                ...
                data: {'product_id': product_id, 'count': add_new_section_count},
                type: "GET",
                success: function (data) {
