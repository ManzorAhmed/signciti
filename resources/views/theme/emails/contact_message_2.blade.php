...
<table width="100%" cellspacing="50" cellpadding="50" border="0" bgcolor="#E7E7E7" class="wrapper">
    ...
    <tr>
        <td>
                    ...
                    <td>
                        <table>
                            <tr style="text-align:center">
                                <td><img width="200" style="margin-top: 20px" src="{{ asset('uploads/'.$logo) }}" /></td>
                            </tr>
                            ...
                            <tr>
                                <td style="text-align:left"><h1 style="font-weight:normal; color:#2e2e2e; font-size:30px; margin:0px; padding-top:60px;">Support Message!</h1>
                                    <p style="font-size:18px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">Hello {{$name}},</p>
                                    <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
                                        You have received a new Contact Message .Below are the details:
                                    </p>
                                     <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
            ...
            <p style="text-align:center; margin:35px auto 0px; font-size:14px; color:#5d5d5d; width:500px; line-height:25px;" >This email was intended for signciti administration.
                © {{ date('Y') }} https://signciti.com/ </p>
        </td>
    </tr>
