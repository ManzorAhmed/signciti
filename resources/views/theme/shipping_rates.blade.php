	...
	<div class="container bg-white">
		<div class="row">
		    <div class="col-md-12 mx-auto p-2 text-center">
                <h2>Custom Made Signs - Fast Turnaround</h2>
			...
			<div class="col-md-12"> 
				<div class="page-head">  
					...
					<p class="p-2 text-info">
						<button class="btn btn-link text-warning font-weight-normal p-0 border rounded p-2 collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">&bull; Click here to show rates <i class="fas fa-angle-down fa-lg text-muted p-2"></i></button>
					...
					<p class="p-2">
						<button class="btn btn-link text-warning font-weight-normal p-0 border rounded p-2 collapsed" data-toggle="collapse" href="#toggle-oversized" style="margin-top: 6px;" aria-expanded="">&bull; Click here to show rates <i class="fas fa-angle-down text-muted fa-lg p-2"></i></button>
					...
					<p class="p-2"> 
						<button class="btn btn-link text-warning font-weight-normal p-0 border rounded p-2 collapsed" data-toggle="collapse" href="#toggle-international" style="margin-top: 6px;">&bull; Click here to show rates <i class="fas fa-angle-down text-muted fa-lg p-2"></i></button>
